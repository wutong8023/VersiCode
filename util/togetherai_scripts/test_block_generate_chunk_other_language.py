"""
test llama3-70B other language
"""
import json
...
def bulid_prompt(version, description) -> str:
    ...
    """
    prompt = f'''
            You are a professional Javascript engineer, and I will provide functional descriptions and versions of specified dependency packages. 
            You need to write code in Javascript to implement this feature based on the functional description and using the dependency package and version I specified. 
            ...
            This code snippet utilizes the jQuery library to implement a simple click event handler. When the user clicks the button, it prints "Button clicked!" to the console.
...
json_path = '../dataset/final_dataset/other_language_data_finalv2/javascript_test_block.json'
