...
block_json_path = '../../dataset/final_dataset/other_language_data_finalv2_result/Llama-3-70b-chat-hf/javascript_test_block.json'
...
for data in data_list:
    ...
    answer_name = data['answer']    #common block
